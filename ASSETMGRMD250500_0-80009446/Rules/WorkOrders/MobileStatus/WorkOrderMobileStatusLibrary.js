...
export default class {
    ...
    static showTimeCaptureMessage(context, mobileStatus, isFinalRequired = false, checkWorkOrderComplete = true) {
    ...
    static showTimeSheetMessage(context) {
        return libThis.showWorkOrderTimesheetMessage(context).then(bool => {
            if (bool) {
                ...
                if (!libCommon.isDefined(context.getClientData().currentObject)) {

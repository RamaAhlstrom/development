...
export default function FunctionalLocationEditEnabled(context) {
    ...
    return ODataLibrary.hasAnyPendingChanges(context.binding) || (enableAttachmentCreate(context) && enableAttachment(context)) || IsEditTechObjectFeatureEnabled(context);
}

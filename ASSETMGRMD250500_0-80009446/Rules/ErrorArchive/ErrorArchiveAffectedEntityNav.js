...
import { TagStates } from '../WCM/OperationalItems/libWCMDocumentItem';
import { OpItemMobileStatusCodes } from '../WCM/OperationalItems/libWCMDocumentItem';
import ValidationLibrary from '../Common/Library/ValidationLibrary';
import OperationalItemEditNav from '../WCM/OperationalItems/Create/OperationalItemEditNav';
    ...
    WCMDocumentItems: {
        Action: (context) => {
            ...
            if (libCom.isCurrentReadLinkLocal(context.binding['@odata.readLink'])) {
                return OperationalItemEditNav(context, false, false);
            }

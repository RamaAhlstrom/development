...
import IsS4ConfirmationItemIsNotCompleted from './IsS4ConfirmationItemIsNotCompleted';
...
export default class ConfirmationItemQABSettings extends QABSettings {
    async generateChips() {
        ...
        this._createAddNoteChip({ 
            ...
            'IsButtonEnabled': await IsS4ConfirmationItemIsNotCompleted(this._context) && await IsAnyNoteTypeAvailable(this._context),
        }),

...
export default async function ProcessCategoryPickerItems(context) {
    return context.read('/SAPAssetManager/Services/AssetManager.service', 'WarehouseTasks', [], '$expand=WarehouseProcessCategory_Nav&$select=ProcCategory,WarehouseProcessCategory_Nav/Description&$orderby=WarehouseTask')
        .then(o => {

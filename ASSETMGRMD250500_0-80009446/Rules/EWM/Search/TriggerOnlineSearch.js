...
export default async function TriggerOnlineSearch(context) {
    ...
    const customQuery = EWMFetchQueryOptions(context);
                    ...
                    case 1:
                        {
                            ...
                            return Promise.all([getData, GetResource(context)]).then(([data, resource]) => {
                                ...
                                if ((data.length === 1) && !resource) {
                                    ...
                                    if ([DocumentTypes.WarehouseOrder, DocumentTypes.WarehouseTask, DocumentTypes.WarehousePhysicalInventoryItem].includes(documentType)) {

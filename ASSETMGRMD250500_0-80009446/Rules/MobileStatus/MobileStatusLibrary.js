            ...
            switch (binding['@odata.type']) {
                case '#sap_mobile.MyWorkOrderHeader':
                    if (binding.OrderMobileStatus_Nav && binding.OrderMobileStatus_Nav.MobileStatus) {
                        ...
                        binding.supervisorLocal = ODataLibrary.hasAnyPendingChanges(binding.OrderMobileStatus_Nav);
                ...
                case '#sap_mobile.MyWorkOrderOperation':
                    if (binding.OperationMobileStatus_Nav && binding.OperationMobileStatus_Nav.MobileStatus) {
                        ...
                        binding.supervisorLocal = ODataLibrary.hasAnyPendingChanges(binding.OperationMobileStatus_Nav);
    ...
    */
    static getMobileStatusValueConstants(context) {
        return {
            ...
            SUCCESS: libCommon.getAppParam(context, 'MOBILESTATUS', context.getGlobalDefinition('/SAPAssetManager/Globals/MobileStatus/ParameterNames/SuccessParameterName.global').getValue()),

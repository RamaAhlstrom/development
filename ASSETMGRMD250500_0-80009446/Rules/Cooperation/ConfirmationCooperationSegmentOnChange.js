import cooperationConfirmationNavWrapper from '../Cooperation/CooperationConfirmationNavWrapper';
...
export default function ConfirmationCooperationSegmentOnChange(context) {
    ...
    if (value === 'Support') {
        formCellContainerProxy.getControl('CooperationSeg').setValue('None', false); //Set to none temporarily in case user cancels scan

...
import libThis from '../../../SAPAssetManager/Rules/Parts/PartLibrary';
...
import isDefenseEnabled from '../../../SAPAssetManager/Rules/Defense/isDefenseEnabled';
...
export default class {
    ...
    static partIssueCreateUpdateFieldValues(pageClientAPI) {
        ...
        try {
           dict.BinNumberSim?.setValue(binding.Material?.MaterialSLocs[0].ZStorageBin);//check object exist or not finally return javascript
        } catch (error) {
           dict.BinNumberSim?.setValue(binding.StorageBin) 
        }
    ...
    */
    static async evalQuantityLessThanMaximum(context, dict) {
        ...
        for (let materialSLoc of materialSLocs) {
            if (materialSLoc.StorageLocation === binding.StorageLocation && materialSLoc.Plant === binding.Plant) {
        ...
        switch (section) {
            ...
            case 'KeyValuePairs':
                switch (key) {
                    ...
                    case 'RequiredQty':
                        ///////////////////////////////////2505upgrade///////////////
                         if(binding.Batch=="")
                            ...
                            {
                                format = sectionProxy.formatNumber(binding.QuantityUnE) + ' ' + binding.UnitOfEntry+ ' / Repairable Spare Part' ;
                            }
                        ///////////////////////////////////2505upgrade///////////////
                       // format = sectionProxy.formatNumber(binding.QuantityUnE) + ' ' + binding.UnitOfEntry;
                        break;
                    ...
                    case 'Bin':
                        ////////////////////////////////////////////
                        let filterdata="$select=ZStorageBin&$filter=Plant eq '" + binding.Plant + "' and StorageLocation eq '" + binding.StorageLocation + "'";
                        ...
                        ////////////////////////////////////////////
                                   return result.getItem(0).ZStorageBin || '-';

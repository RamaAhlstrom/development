...
export default function SetMaterialUoM(context) {
    ...
    try {
            ...
            context.read(service, returnValue, [], query).then(result => {
                if (result && result.getItem(0)) {
                    ...
                    if (batchListPicker && !isMultipleTechnician) {
                        ...
                        //////////////////////////////////////////////////////////////
                        setTimeout(() => {
                             materialUOMListPicker.setValue(context.getValue()[0].BindingObject.Material.BaseUOM)
                         }, 1500);
                         /////////////////////////////////////////////////////////////////
        ...
        // If Storage Location picker is empty or only single value selected, set it to the current item's SLoc
        ...
        const materialSLocValue = materialSLocPicker.getValue();
        if ((!libCom.isDefined(materialSLocValue) || materialSLocValue.length === 1) && libCom.isDefined(parts?.StorageLocation)) {

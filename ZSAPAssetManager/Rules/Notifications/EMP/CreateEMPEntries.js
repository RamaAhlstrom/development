...
import CurrentTime from '../../../../SAPAssetManager/Rules/DateTime/CurrentTime';
import CurrentDateTime from '../../../../SAPAssetManager/Rules/DateTime/CurrentDateTime';
import MobileStatusNotificationOverallStatusConfig from '../../../../SAPAssetManager/Rules/MobileStatus/MobileStatusNotificationOverallStatusConfig';
import GenerateLocalID from '../../../../SAPAssetManager/Rules/Common/GenerateLocalID';
import WorkOrderOperationPersonNum from '../../../../SAPAssetManager/Rules/WorkOrders/Operations/WorkOrderOperationPersonNum';
import AppVersionInfo from '../../../../SAPAssetManager/Rules/UserProfile/AppVersionInfo';
import ValidationLibrary from '../../../../SAPAssetManager/Rules/Extensions/EventLoggers/Telemetry/TelemetryLibrary';
import TelemetryLibrary from '../../../../SAPAssetManager/Rules/Extensions/EventLoggers/Telemetry/TelemetryLibrary';
	...
	await Promise.all(promises).then(async ([ObjectKey, PhaseModelStatusConfig]) => {
		...
		if (currKey) {
			...
			else
			{
				...
				if(mobileStatusLinks[1].Target.ReadLink==undefined)
					{
						mobileStatusLinks[1].Target.ReadLink="EAMOverallStatusConfigs(Status='R005',EAMOverallStatusProfile='ZPMSP1')"
					}
			}
		...
		'Properties': {
			...
			'CreateLinks': [
				...
				},
				{
					...
					'Target': {
						'EntitySet': 'EAMOverallStatusConfigs',
						'ReadLink': "EAMOverallStatusConfigs(Status='R125',EAMOverallStatusProfile='ZPMSP1')",
					},
				},
			],
			'Headers': {

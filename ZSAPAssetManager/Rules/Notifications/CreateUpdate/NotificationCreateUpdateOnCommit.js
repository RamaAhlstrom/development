        ...
        if (!ValidationLibrary.evalIsEmpty(type) && !ValidationLibrary.evalIsEmpty(descr)) {
            ...
            return Promise.all(promises).then(results => {
                ...
                let notificationCreateProperties = {
                   ...
                   // 'ZCurrentLocation':clientAPI.getControls()[0].getControl('GeoLocation').getValue()==undefined ? '' : clientAPI.getControls()[0].getControl('GeoLocation').getValue(),
                };
                ...
                ///////////////////////////////////////////////////////////
                if(notificationCreateProperties.NotifProcessingContext == "01" || notificationCreateProperties.NotifProcessingContext == "03")
                    {
                        if(clientAPI.evaluateTargetPathForAPI('#Control:Persnal_Num').getValue().length!=0)
                            {
                                notificationCreateProperties.AddressNum =  clientAPI.evaluateTargetPathForAPI('#Control:Persnal_Num').getValue()[0].ReturnValue;
                            }
                    }
                    /////////////////////////////////////////////////////////
                }

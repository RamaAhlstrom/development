...
import FastFiltersHelper from '../../../SAPAssetManager/Rules/FastFilters/FastFiltersHelper';
...
export const TIME_FILTERS = {
    ...
    'DUE_DATE_TODAY1': 'FILTER_DUE_DATE_TODAY1',
};

export const FAST_FILTERS = {
    'ASSIGNED_TO_ME': 'FILTER_ASSIGNED_TO_ME',    
    'ASSIGNED_TO_ME1': 'FILTER_ASSIGNED_TO_ME1',
...
export default class FastFilters {
    ...
    setAllFiltersCaption(context) {
        this.filtersNameMapping = {
            [FAST_FILTERS.ASSIGNED_TO_ME]: context.localizeText('assigned_to_me2'),
            [FAST_FILTERS.ASSIGNED_TO_ME1]: context.localizeText('assigned_to_me1'),
            ...
            [TIME_FILTERS.DUE_DATE_TODAY]: context.localizeText('map_search_wo_due_today'),
             [TIME_FILTERS.DUE_DATE_TODAY1]: context.localizeText('map_search_wo_due_today1'),

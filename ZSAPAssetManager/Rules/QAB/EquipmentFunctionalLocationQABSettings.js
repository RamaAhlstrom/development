...
// import libBOM from '../Material/BOM/BOMVisiblecopy';
...
import libBOM from '../../../ZSAPAssetManager/Rules/Material/BOM/BOMVisiblecopy';
...
export default class EquipmentFunctionalLocationQABSettings extends QABSettings {
    ...
    async generateChips() {
        ...
        if (this._isOnlineEquipment || this._isOnlineFloc) {
            ...
            chips = [
                ...
                this._createSDFChip(),
                await this._createTakeReadingsChipG(),
            ];
        }
    ...
    async _createTakeReadingsChipG() {
        let textv=await libBOM(this._context);//.isBOMVisible(this._context);
        //alert(textv);
        
        return super._createTakeReadingsChipG({
            'IsButtonEnabled': await libBOM(this._context),
        });
    }
    ////////////////////////////////////////////////////////////////

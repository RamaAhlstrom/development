export default async function Zmobilecmplt_Textdisplay(context) {
    ...
    if (text == "" || text == undefined) {
        text = "Mango";//context.localizeText("JSA_Not_Done");//"JSA Not Done"
    }
    else if (text == "X") {
        text = "Red";//context.localizeText("JSA_Not_OK");//"JSA Not OK"
    }
    else {
        text = "Green";//context.localizeText("JSA_Completed");//"JSA Completed"
    }
    return text

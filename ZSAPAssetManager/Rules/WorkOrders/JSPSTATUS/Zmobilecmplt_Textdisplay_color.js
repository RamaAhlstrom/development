export default async function Zmobilecmplt_Textdisplay(context) {
    ...
    if (text == "" || text == undefined) {
        text = "#ffbf00";//context.localizeText("JSA_Not_Done");//"JSA Not Done"
    }
    else if (text == "X") {
        text = "#f70a16";//context.localizeText("JSA_Not_OK");//"JSA Not OK"
    }
    else {
        text = "#008000";//context.localizeText("JSA_Completed");//"JSA Completed"
    }
    return text

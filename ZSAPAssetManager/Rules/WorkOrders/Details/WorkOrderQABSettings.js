...
import ConfirmationCreateIsEnabledForWO from '../../../../SAPAssetManager/Rules/Confirmations/CreateUpdate/ConfirmationCreateIsEnabledForWO';
...
export default class WorkOrderQABSettings extends QABSettings {
    ...
    async _createViewMapChip() {
        ...
        'IsEnabled': true,
        'Action': '/ZSAPAssetManager/Rules/Zstatusgridtable.js',

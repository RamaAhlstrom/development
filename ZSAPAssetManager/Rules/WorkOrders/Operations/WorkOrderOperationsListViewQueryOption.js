...
import { OperationConstants as Constants, OperationLibrary } from '../../../../SAPAssetManager/Rules/WorkOrders/Operations/WorkOrderOperationLibrary';
...
export default function WorkOrderOperationsListViewQueryOption(context) {
    ...
    if (context.dataQueryBuilder) {
        ...
        if (queryBuilder) {
            ...
            //////////////extension/////////
           queryBuilder.expand('MyWorkOrderOperationCapacityRequirement_');
           queryBuilder.expand('MyWorkOrderOperationCapacityRequirement_/Employee_Nav');
           //////////////extension/////////

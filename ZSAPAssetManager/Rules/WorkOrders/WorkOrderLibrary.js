...
export class WorkOrderEventLibrary {
    ...
    static WorkOrdersListViewFormat(context) {
        ...
        switch (property) {
                    case 'Tags':
                        //////////////////////////////////////////////////////////////////////
                        if(context.binding.ZJSAAPPL=="X")
                        {
                            if(context.binding.ZISA=="XX")
                            {
                                //  value="JSA Completed";
                                value=context.localizeText('JSA_Completed')
                            }else if(context.binding.ZISA=="XX")
                            {
                               //value="JSA Not OK"
                               value=context.localizeText('JSA_Not_OK')
                            }
                            else{
                               // value="JSA Not Done"
                               value=context.localizeText('JSA_Not_Done')
                            }
                        }
                        else
                        {

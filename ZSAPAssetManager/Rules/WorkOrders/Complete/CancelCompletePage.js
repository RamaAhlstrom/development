...
import { IsBulkConfirmationQueueActive, RunNextBulkConfirmationAction } from '../../../../SAPAssetManager/Rules/WorkOrders/Operations/BulkConfirmationQueue';
...
export default function CancelCompletePage(context) {
  ...
  if (WorkOrderCompletionLibrary.getStepValue(context, 'note1')) {
            resetActions.push(WorkOrderCompletionLibrary.resetStep(context,
                WorkOrderCompletionLibrary.getStepDataLink(context, 'note1')));
            WorkOrderCompletionLibrary.updateStepState(context, 'note1', {
                value: '',
                data: '',
                link: '',
            });

...
import { resetTimeStepAction } from '../../../../SAPAssetManager/Rules/WorkOrders/Complete//CancelCompletePage';
...
export default function ResetCompleteScreenFields(context) {
  ...
  if (WorkOrderCompletionLibrary.getStepValue(page, 'note1')) {
            resetActions.push(WorkOrderCompletionLibrary.resetStep(page,
                WorkOrderCompletionLibrary.getStepDataLink(page, 'note1')));
            WorkOrderCompletionLibrary.updateStepState(page, 'note1', {
                value: '',
                data: '',
                link: '',
            });
